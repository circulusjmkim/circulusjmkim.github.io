const MENUS = [
  ...
  },
  {
    ...
    list: [
      ...
      {value: 'user_delete_info', label: '사용자 데이터 클리어', desc: '사용자의 물리적 또는 논리적 아이디와 관련된 모든 데이터(사용자의 로봇, 로봇에 설치된 bot 정보, 해당 로봇 bot의 모든 연관 데이터(Optional))를 삭제합니다.\n*테스트 데이터 삭제에만 사용할 것을 권장합니다.'},
      {value: 'user_update-withdraw', label: '사용자 탈퇴 정보 삭제 및 백업', desc: '한달 간격으로 이루어지는 탈퇴 사용자에 대한 정보 백업을 탈퇴 회원 정보로 조회하여 즉시 실행합니다. (탈퇴한 아이디, 이메일, 전화번호 등의 재사용 요청 시 사용)'},
